...
$config = [
    ...
    // описание
    'shortTextDonate' => 'Дранік-сервер – сервер для грамадства. Дзякуючы яму грамадскія арганізацыі могуць атрымаць бескаштоўнае месца для сайта, а айці-валанцеры - увасобіць у жыццё свае праекты, змяняючы да лепшага наша асяроддзе. Адзін крок аддзяляе нас з вамі ад стварэння самадастатковай лічбавай прасторы.',
    // необходимая сумма
